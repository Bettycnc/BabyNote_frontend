...
const NewData = () => {
  ...
  const handelAddData = () => {
    ...
    if (activeAlim !== false) {
      ...
      fetch(
        `http://localhost:3000/babyData/${user.babies[0]._id}/alimentation`,
        {
          method: "POST",
    ...
    if (urine !== false || gambling !== false) {
      ...
      fetch(
        `http://localhost:3000/babyData/${user.babies[0]._id}/elimination`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify(data),
    ...
    if (temperature !== null) {
      ...
      fetch(
        `http://localhost:3000/babyData/${user.babies[0]._id}/temperature`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify(data),
      ...
      <div className={styles.data}>
        ...
        <div className={styles.horaireContainer}>
          ...
          <div className={styles.horaireInput}>
            ...
            <span
              className={styles.timePartMinute}
              onClick={() => handleOpen("minute")}
            >
            ...
            <div className={styles.addDataAlim}>
              <div className={styles.alimchoice}>
                <button
                  ...
                  style={{ opacity: activeAlim === "biberon" ? 1 : 0.2 }}
                  onClick={() => {
                    setActiveAlim("biberon"),
                      setComplement(false),
                      setSeinChoice("");
                  }}
                >
                ...
                <button
                  className={styles.buttonAlim}
                  style={{ opacity: activeAlim === "allaitement" ? 1 : 0.2 }}
                  onClick={() => setActiveAlim("allaitement")}
                >
              ...
              {activeAlim === "biberon" && (
                <div>
                  ...
                  >
                    <Typography variant="body2">0mL</Typography>
                    <Typography
                      variant="body2"
                    ...
                    <Typography variant="body2">150mL</Typography>
                  </Box>
                </div>
              )}
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          ...
                          checked={seinChoice.includes("Droit")}
                          sx={{
                    ...
                    {complement === true && (
                      <div>
                        <Autocomplete
                          ...
                          renderInput={(params) => (
                            <TextField {...params} label="Type de complément" />
                          )}
                        />
                        <Autocomplete
                          ...
                          renderInput={(params) => (
                            <TextField
                              {...params}
                              label="Méthode d'administration"
                            />
                          )}
                        />
                        <Box sx={{ width: 300, marginTop: "15px" }}>
        ...
        <div className={styles.weightContainer}>
          ...
          {showWeight === true && (
            <div className={styles.addDataWeight}>
              <button className={styles.weightBtn} onClick={handelWeightLess}>
                -
              </button>
              <p className={styles.weightValue}>{weight} g</p>
              <button className={styles.weightBtn} onClick={handelWeightMore}>
                +
              </button>
            </div>
          )}
            ...
            <div className={styles.addDataTemp}>
              ...
              >
                <Slider
                  ...
                  min={35}
                  max={41}
                  onChange={handelValTemp}
                />
              </Box>
              <Box sx={{ display: "flex", justifyContent: "space-between" }}>
                <Typography variant="body2">35°C</Typography>
                {temperature !== null && (
                  <Typography
                    variant="body2"
                    sx={{ fontWeight: "800", fontSize: "18px" }}
                ...
                <Typography variant="body2">41°C</Typography>
              </Box>
            </div>
          )}
        </div>
        ...
        <Link href={"/babyTab"}>
          <button className={styles.button} onClick={handelAddData}>
            Valider
          </button>
        </Link>
      </div>
