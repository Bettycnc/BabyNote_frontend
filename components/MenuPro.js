  ...
  return (
    <div className={styles.containerPro}>
      <div className={styles.header}>
        <p className={styles.titre}>Bonjour, {user.username} ! </p>
      ...
      <div className={styles.compteOption}>
        ...
        <button className={styles.btn} onClick={showModalUser}>
          Mon compte
        </button>
      </div>
      ...
      <Modal open={openModalDeletePatient} onClose={handelCloseDeletePatient}>
        ...
        >
          ...
          <Popover
            className={styles.popoverMother}
            id="delete-popover"
            open={anchorEl}
            anchorEl={anchorEl}
            onClose={handleClose}
          ...
          >
            {uniqueMother.map((mother, index) => (
              ...
              <Button
                ...
                onClick={() => {
                  handelDeletePatient(mother._id);
                }}
              >
                mme. {mother.lastname} - chambre {mother.room}
              </Button>
              //   </Box>
            ))}
          </Popover>
